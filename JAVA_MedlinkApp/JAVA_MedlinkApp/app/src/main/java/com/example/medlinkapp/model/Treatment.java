...
public class Treatment {
    ...
    private Date trea_date_start;
    private Date trea_date_end;
    ...
    public Treatment(int trea_id, String trea_name, String trea_description, Date trea_date_start,
                     Date trea_date_end, String trea_observations, boolean trea_is_active,
    ...
    public Treatment(int trea_id, String trea_name, String trea_description, Date trea_date_start,
                     Date trea_date_end, boolean trea_is_active, int trea_doctor_id,
                     int trea_patient_id) {
        this.trea_id = trea_id;
        this.trea_name = trea_name;
        this.trea_description = trea_description;
    ...
    public Date getTrea_date_start() {
        return trea_date_start;
    }

    public void setTrea_date_start(Date trea_date_start) {
        this.trea_date_start = trea_date_start;
    }

    public Date getTrea_date_end() {
        return trea_date_end;
    }

    public void setTrea_date_end(Date trea_date_end) {
        this.trea_date_end = trea_date_end;
    }
